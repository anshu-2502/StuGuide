			...
			<Container className='createProfile mt-1'>
				...
				<Form className='profile-form text-start d-flex flex-wrap' onSubmit={(e) => onSubmit(e)}>
					<Form.Group as={Col} md='12' controlId='companyName'>
						<Form.Label>Working Company/School Name</Form.Label>
						<Form.Control
							type='text'
							placeholder='ABC Infotech Private Limited / DAV public School '
							name='company'
							value={company}
							onChange={onChange}
							required
					...
					<Form.Group as={Col} md='6' controlId='companyWebsite'>
						<Form.Label>Company or School Website</Form.Label>
					...
					<Form.Group as={Col} md='6' controlId='skills'>
						...
						<Form.Control
							type='text'
							placeholder='eg. HTML,CSS,Physics,Mathematics'
							name='skills'
							value={skills}
							onChange={onChange}
							required
